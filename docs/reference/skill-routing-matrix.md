...
| Bygge/endre frontend (React/Next) | nye sider, komponenter, state/datahenting, forms | `ai-agent-doc-compliance.skill.md`, `frontend-architecture-and-code-quality-react-next.skill.md`, `clean-code.skill.md`, `test-drevet-utvikling.skill.md`, `api-contracts-and-versioning.skill.md` | `frontend-container-composition-and-props.skill.md`, `frontend-accessibility-and-ux-baseline.skill.md`, `authorization-and-access-control.skill.md` |
...
| Feilsøke heng/incident lokalt     | app står fast, request timeout, ustabil runtime  | `ai-agent-doc-compliance.skill.md`, `project-documentation-system.skill.md`                                                                                                                        | `test-drevet-utvikling.skill.md`, `clean-architecture.skill.md`                                                                                     |
